...
print(helper.get_appx_details(product.product['ICPS_1.1']['get_details']['appx_name']))
print(helper.get_all_oem(product.product['ICPS_1.1']['get_details']['component_file']))
print(helper.get_all_oem(product.product['ICPS_1.1']['get_details']['extension_file']))

if product.product['ICPS_1.1']['get_details'].get('appx_name', None):
    appx_details = helper.get_appx_details(product.product['ICPS_1.1']['get_details']['appx_name'])
    if appx_details:
        print(helper.remove_appx(appx_details['PackageFullName']))

if product.product['ICPS_1.1']['get_details'].get('component_file', None):
    driver_details = helper.get_all_oem(product.product['ICPS_1.1']['get_details']['component_file'])
    for each_oem in driver_details:
        print(helper.remove_driver(each_oem))

if product.product['ICPS_1.1']['get_details'].get('extension_file', None):
    driver_details = helper.get_all_oem(product.product['ICPS_1.1']['get_details']['extension_file'])
    for each_oem in driver_details:
        print(helper.remove_driver(each_oem))
