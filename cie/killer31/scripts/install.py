...
print(os.system(r'C:\Windows\system32\pnputil -i -a C:\Users\CIE\Documents\UWD\Win64\Drivers\KillerNetworkComponent\KillerNetworkComponent.inf'))
time.sleep(5)
print(os.system(r'C:\Windows\system32\pnputil -i -a C:\Users\CIE\Documents\UWD\Win64\Drivers\KillerNetworkExtension\KillerNetworkExtension.inf'))
time.sleep(5)

appx_path= glob.glob('/Users/CIE/Documents/UWD/Win64/App/KillerControlCenter*.appx')[-1]
